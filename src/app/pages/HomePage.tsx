...
const IMG = {
  ...
  office: "https://cdn.builder.io/api/v1/image/assets%2Fac4f22b6755541c6871d8f6adda59355%2Fe863a177cd69489983a67ca380d958b4",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-7">
          {featureCards.map((card, index) => (
            <Reveal key={card.title} delay={index * 0.1}>
              <div className="group relative p-8 md:p-9 rounded-[16px] overflow-hidden transition-all duration-500 hover:shadow-lg h-full flex flex-col text-center" style={{ background: "#e9ecf2", boxShadow: "0 4px 12px rgba(15,23,42,0.08)" }}>
